...
// Estrutura de dados em árvore para representar decisões e caminhos
/**
...
class CustomerJourneyTree {
    ...
    fromJSON(jsonData) {
        if (!jsonData)
            return;
        const jsonToNode = (jsonNode, parent = null) => {
...
class JourneyUI {
     ...
     */
    createModal(title, fields, onSubmit) {
